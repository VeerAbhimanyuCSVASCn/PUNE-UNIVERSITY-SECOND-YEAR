...
int main()
{
    system("color f0");
    int a;
    cout<<"ENTER NO OF NODES IN A GRRAPH - ";
    cin>>a;
    b=new int*[a];
    for(int i=0;i<a;i++)
        b[i] = new int [a];

    cout<<"ENTER THE DATA MATRIX - ";
    for(int i=0;i<a;i++)
        for(int j=0;j<a;j++)
            cin>>b[i][j];
...
int v=a;
        ...
        for(int i=0;i<a;i++)
        {
            ...
            {
                if(abhimanyu[i].distance > abhimanyu[r].distance + b[num][i])
                        abhimanyu[i].distance = abhimanyu[r].distance + b[num][i];
            }
        }
        --v;
        }
        ...
        for(int i=0;i<a;i++)
        {
            cout<<"\n\nPOSSIBLE SHORTEST PATHS FROM Oth NODE to "<<i<<"th node IS - "<<abhimanyu[i].distance<<endl;
        }
